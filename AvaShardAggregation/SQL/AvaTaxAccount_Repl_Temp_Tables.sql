...
CREATE TABLE dbo.Document_Temp_Shard_2
	(
	DocumentId                          BIGINT NOT NULL,
	DocumentTypeId                      TINYINT NOT NULL,
	CompanyId                           INT NOT NULL,
...
CREATE TABLE dbo.DocumentLine_Temp_Shard_2
	(
	DocumentLineId           BIGINT NOT NULL,
	DocumentId               BIGINT NOT NULL,
	[LineNo]                 VARCHAR (50),
...
IF OBJECT_ID ('dbo.DocumentLineDetail_Temp_Shard_2') IS NOT NULL
	DROP TABLE dbo.DocumentLineDetail_Temp_Shard_2
GO

CREATE TABLE dbo.DocumentLineDetail_Temp_Shard_2
	(
	DocumentLineDetailId BIGINT NOT NULL,
	DocumentLineId       BIGINT NOT NULL,
	JurisTypeId          VARCHAR (3),
	...
	ReturnsTaxTypeID     INT,
	IsNonPassThru        BIT,
	CONSTRAINT PK_DocumentLineDetail_Temp_Shard_2 PRIMARY KEY (DocumentLineDetailId)
	)
GO
...
IF OBJECT_ID ('dbo.DocumentParameterBag_Temp_Shard_2') IS NOT NULL
	DROP TABLE dbo.DocumentParameterBag_Temp_Shard_2
GO

CREATE TABLE dbo.DocumentParameterBag_Temp_Shard_2
	(
	DocumentParameterBagId BIGINT NOT NULL,
	DocumentId             BIGINT NOT NULL,
	Name                   VARCHAR (50) NOT NULL,
	...
	UOMIdSystem            INT,
	ValueSystem            VARCHAR (50),
	CONSTRAINT PK_DocumentParameterBag_Temp_Shard_2 PRIMARY KEY (DocumentParameterBagId)
	)
GO
