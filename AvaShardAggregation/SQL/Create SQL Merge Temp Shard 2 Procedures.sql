...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_DocumentLine_From_Temp_Shard_2
AS
BEGIN
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_DocumentLineDetail_From_Temp_Shard_2
AS
BEGIN
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_DocumentParameterBag_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT DocumentParameterBagId, DocumentId, Name, Value, UOMId, UOMIdSystem, ValueSystem FROM dbo.DocumentParameterBag_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_Account_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT AccountId, LicenseKey, Salt, AccountName, SiteId, EffDate, EndDate, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate, AccountStatusId, CRMId, CRMIdSTR FROM dbo.Account_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_AddressServiceConfig_From_Temp_Shard_2
AS
BEGIN

MERGE dbo.AddressServiceConfig AS target
USING (SELECT AccountId, IsUpperCase, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate, IsJaasDisabled FROM dbo.AddressServiceConfig_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_DocumentCodeChangeList_From_Temp_Shard_2
AS
BEGIN

MERGE dbo.DocumentCodeChangeList AS target
USING (SELECT AccountId, DocumentCode, Committed, ModifiedDate FROM dbo.DocumentCodeChangeList_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_BoundaryOverride_From_Temp_Shard_2
AS
BEGIN
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_JurisdictionOverride_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT JurisdictionOverrideId, BoundaryOverrideId, AccountId, Address, City, Region, PostalCode, Description, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate, EffDate, EndDate FROM dbo.JurisdictionOverride_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_Service_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT ServiceId, AccountId, ServiceTypeId, Quantity, CompanyId, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate, EffDate, EndDate FROM dbo.Service_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_Subscription_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT SubscriptionId, AccountId, PartnerId, ReferenceCode, SubscriptionTypeId, CountryCode, RegionCode, EffDate, EndDate, CancelDate, IsActive, CreatedDate, ModifiedDate, CreatedUserId, ModifiedUserId FROM dbo.Subscription_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_User_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT UserId, AccountId, UserName, FirstName, LastName, Password, PasswordStatusId, Email, PostalCode, SecurityRoleId, IsActive, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate, FailedLoginAttempts, CompanyId, SubjectId FROM dbo.User_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_Company_From_Temp_Shard_2
AS
BEGIN
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_TaxRule_From_Temp_Shard_2
AS
BEGIN
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_CompanyContact_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT CompanyContactId, CompanyId, CompanyContactCode, ContactRoleTypeId, FirstName, MiddleName, LastName, Title, Line1, Line2, Line3, City, Region, PostalCode, Country, Email, Phone, Phone2, Fax, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate FROM dbo.CompanyContact_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_CompanyLocation_From_Temp_Shard_2
AS
BEGIN
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_ExemptCert_From_Temp_Shard_2
AS
BEGIN
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_Nexus_From_Temp_Shard_2
AS
BEGIN
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_TaxCode_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT TaxCodeId, TaxCode, TaxCodeTypeId, CompanyId, Description, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate, ParentTaxCode, IsPhysical, GoodsServiceCode, EntityUseCode, IsActive, IsSSTCertified FROM dbo.TaxCode_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_UPCCodeLookup_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT UPCCodeLookupId, UPCCode, LegacyTaxCode, CompanyId, UPCDescription, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate, EffDate, EndDate, Usage, IsSystem FROM dbo.UPCCodeLookup_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_AvaCertServiceConfig_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT AvaCertServiceConfigId, CompanyId, AvaCertServiceStatusId, IsUpdateEnabled, ClientCode, OrgCode, AllowPending, LastUpdate, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate FROM dbo.AvaCertServiceConfig_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_AvaCommsServiceConfig_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT AvaCommsConfigId, CompanyId, ClientId, ClientProfileId, Parameters, LastUpdate, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate FROM dbo.AvaCommsServiceConfig_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_BRCompanySecurityCertificate_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT CompanySecurityCertificateId, CompanyId, Password, Certificate, ExpirationDate, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate FROM dbo.BRCompanySecurityCertificate_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_BRTaxRegimeBuyerTypeConfig_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT BRTaxRegimeBuyerTypeConfigId, CompanyId, Country, JurisName, JurisCode, JurisTypeId, TaxRuleTypeId, TaxCodeId, TaxRegime, IsRateCumulative, BuyerType, RateTypeId, Value, EffDate, EndDate, Description, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate FROM dbo.BRTaxRegimeBuyerTypeConfig_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_CompanyTaxForm_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT CompanyTaxFormId, CompanyId, LibraryTaxFormId, FilingStatusId, CloseDate, FinalDate, FilingFrequencyId, ModifiedUserId, TaxFormPDF, EffDate, EndDate, CreatedUserId, CreatedDate, ModifiedDate FROM dbo.CompanyTaxForm_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_Return_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT ReturnId, TransmissionId, CompanyId, ReturnTypeId, ReturnStatusId, BeginDate, EndDate, FiledDate, CreatedDate, ModifiedDate, JurisCode, JurisName, JurisTypeId, Region, ReturnName FROM dbo.Return_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_TaxRuleProductDetail_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT TaxRuleProductDetailId, TaxRuleId, ProductId, ProductTypeId, EffDate, EndDate, ModifiedDate FROM dbo.TaxRuleProductDetail_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_TaxCodeAttribute_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT TaxCodeAttributeId, TaxCodeId, Name, Value, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate, UOMId FROM dbo.TaxCodeAttribute_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_TaxCodeCategorization_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT TaxCodeCategorizationId, TaxCodeId, Country, TaxCodeTypeId, IsPhysical, EffDate, EndDate, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate FROM dbo.TaxCodeCategorization_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_Item_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT ItemId, ItemCode, CompanyId, TaxCodeId, Description, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate FROM dbo.Item_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_ItemAttribute_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT ItemAttributeId, ItemId, Name, Value, CreatedUserId, CreatedDate, ModifiedUserId, ModifiedDate, UOMId FROM dbo.ItemAttribute_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_DocumentAddress_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT DocumentAddressId, DocumentId, Line1, City, Country, Region, PostalCode, BoundaryLevelId, JurisCode, County, CitySignature, TaxRegionId, GeoCode, GeocodeTypeId, ValidateStatusId, Latitude, Longitude, DocumentQueueAddressId, AddressLine1, AddressLine2, AddressLine3 FROM dbo.DocumentAddress_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_DocumentProperty_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT DocumentPropertyId, DocumentId, ReferenceCode, VATNumberTypeId FROM dbo.DocumentProperty_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_DocumentLineParameterBag_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT DocumentLineParameterBagId, DocumentLineId, Name, Value, UOMId, UOMIdSystem, ValueSystem FROM dbo.DocumentLineParameterBag_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_DocumentLineProperty_From_Temp_Shard_2
AS
BEGIN
...
USING (SELECT DocumentLinePropertyId, DocumentLineId, VATCode, VATNumberTypeId, HSCodeId, HSCode, HSCodeUsed, CIF FROM dbo.DocumentLineProperty_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_DocumentLineDetailProperty_From_Temp_Shard_2
AS
BEGIN


MERGE dbo.DocumentLineDetailProperty AS target
USING (SELECT DocumentLineDetailId, TaxTypeMappingId, RateTypeTaxTypeMappingId, IsFee, TaxAuthorityId, ReportLevel FROM dbo.DocumentLineDetailProperty_Temp_Shard_2) 
...
CREATE OR ALTER PROCEDURE dbo.sp_Merge_CompanyReturn_From_Temp_Shard_2
AS
BEGIN
