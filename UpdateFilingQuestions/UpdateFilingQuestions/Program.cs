...
namespace UpdateFilingQuestions
{
    class Program
    {
        /// <summary>
    ...
    public class FilingQuestionUpdate
    {
        public int FilingQuestionId { get; set; }
        ...
        public String RegexTests { get; set; }
        public int CreatedUserId { get; set; }
        public DateTime CreatedDate { get; set; }
        public int ModifiedUserId { get; set; }
        public DateTime ModifiedDate { get; set; }
        public Boolean Required { get; set; }
        public int HideForFilingMethodId { get; set; }
        public String Country { get; set; }
        public String Region { get; set; }
        public String FilingQuestionCode { get; set; }
        public String JsonPath { get; set; }
        public int ImportPathId { get; set; }
        public int ImportGroupId { get; set; }
        public String DefaultAnswer { get; set; }
    }

    public class FilingQuestion
    {
    ...
    public partial class FilingQuestionDelete
    {
